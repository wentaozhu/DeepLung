config = {'train_data_path':['/media/data1/wentao/tianchi/luna16/subset9/',
          ...
          'val_data_path':['/media/data1/wentao/tianchi/luna16/subset0/'], 
          'test_data_path':['/media/data1/wentao/tianchi/luna16/subset0/'], 
